    ...
    >
      <div class="content">
        ...
        <p>
          ...
          <!-- Despite some CSS tweaks, they used the codebase up until a couple years ago. It was definitely overdue, so no hard feelings here. ;) -->
        </p>
      </div>
    </section>
      ...
      <div class="content">
        ...
        <ul>
          <li data-aos="fade-up" data-aos-anchor-placement="center-bottom">
            ...
            <small>Teaching Assistant for Foundation Media Coursework</small>
          </li>
          <li data-aos="fade-up" data-aos-anchor-placement="center-bottom">
